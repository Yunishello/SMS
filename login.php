	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-5 bg-light mt-5 px-0">
				<div class="card">
					<div class="card-head text-uppercase text-center text-white bg-danger p-3"><h2>users login</h2></div>
					<div class="card-body">
						<form action="includes/login.php" method="post" class="p-4">
							...
							<a href="index.php" class="btn btn-primary float-right">Register</a>
						</form>
